      ...
      {book &&
        book.map(singleBook =>  (
          <div key={singleBook._id} className="Book-Detailss">
            ...
            <img className="book-imagee" src={singleBook.image} alt={singleBook.name} />
            ...
            <h1 >Available Quantity: {singleBook.quantity}</h1>
              ...
              <h1 className="add-to-cart-quantity">
                Add Quantity:
                <RemoveCircleIcon className="add-to-cart-iconss" onClick={handleDecrease} />
                <input
                ...
                />
                <AddCircleSharpIcon className="add-to-cart-iconss" onClick={handleIncrease} />
                 
              </h1>
              
            </div>
            <button className="add-to-cart-buttonn" 
